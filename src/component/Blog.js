...
function Blog() {
  return (
    <section className="pt-24 pb-24 bg-gray-200">
      <div className="pt-10 px-4 mx-auto max-w-4xl bg-white rounded-xl shadow-lg md:px-12">
        <div role="main" className="flex flex-col items-center justify-center">
          <h1 className="text-4xl font-semibold leading-9 text-center text-gray-800">Blogs</h1>
          <p className="text-base leading-normal text-center text-gray-800 mt-4 lg:w-1/2 md:w-10/12 w-11/12">All are blogs.</p>
        </div>
        <div className="pb-16 lg:flex items-stretch md:mt-12 mt-8">
              ...
              <div className="sm:w-1/2 relative">
                <div>
                  ...
                  <div className="absolute bottom-0 left-0 p-6">
                    <h2 className="text-base font-semibold 5 text-white">The Decorated Ways</h2>
                    <p className="text-sm leading-4 text-white mt-2">Dive into minimalism</p>
