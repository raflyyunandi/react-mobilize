...
function Contact() {
  return (
    ...
    <div className="px-4 mx-auto max-w-4xl bg-white dark:bg-gray-900 rounded-xl shadow-lg md:px-12">
      <div className="pb-10 lg:flex lg:items-center lg:-mx-6">
        <div className="lg:w-1/2 lg:mx-6">
          ...
          <div className="mt-8 lg:w-1/2 lg:mx-6">
            <div className="w-full px-8 py-10 mx-auto overflow-hidden bg-white dark:bg-gray-900 rounded-lg shadow-2xl lg:max-w-xl ">
              <h1 className="text-lg font-medium text-gray-700 dark:text-gray-200">What do you want to ask</h1>
